...
const LanguageModal = ({languageModal,setLanguageModal}) => {
    ...
    return(
        ...
        <div className="language_modal">
          ...
          <div className="language_modal_title">
            {t("languageModal.title")}
          </div>
          <div className="language_modal_languages">
            <div className="row">
              <div className="col text-end">
                <div className={`language_item ${i18n.language === "tr" ? "selected":""}`} onClick={() => i18n.changeLanguage("tr")}>
                  <img src={trIcon} alt="" className="language_item_img" />
                  <span className="language_item_text">{t("languageModal.turkishButtonText")}</span>
                </div>
              </div>
              <div className="col text-start">
                <div className={`language_item ${i18n.language === "en" ? "selected":""}`} onClick={() => i18n.changeLanguage("en")}>
                  <img src={enIcon} alt="" className="language_item_img" />
                  <span className="language_item_text">{t("languageModal.englishButtonText")}</span>
                </div>
              </div>
            </div>
          </div>
